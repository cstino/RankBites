    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (authMode === 'login') {
                ...
                // Check for admin invite before signup (optional - may fail due to RLS)
                let invite = null
                try {
                    ...
                    // Ignore error - admin_invites check is optional for regular users
                }
                ...
                if (signUpError) {
                    ...
                    if (invite) {
                        ...
                        showToast('success', 'Benvenuto Admin!', `Account creato come ${invite.role}. Controlla la tua email per confermare la registrazione.`)
                    } else {
